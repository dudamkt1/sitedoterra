...
update public.ai_templates set structure = jsonb_set(structure, '{fields,8,default}', '"https://images.unsplash.com/photo-1617897903246-719242758050?w=800&auto=format&fit=crop&q=80"'::jsonb) where code = 'carrossel-educativo';
